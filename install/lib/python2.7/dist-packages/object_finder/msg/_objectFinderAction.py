  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7di3I.pack(_x.action_result.result.object_pose.pose.position.x, _x.action_result.result.object_pose.pose.position.y, _x.action_result.result.object_pose.pose.position.z, _x.action_result.result.object_pose.pose.orientation.x, _x.action_result.result.object_pose.pose.orientation.y, _x.action_result.result.object_pose.pose.orientation.z, _x.action_result.result.object_pose.pose.orientation.w, _x.action_result.result.object_id, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
