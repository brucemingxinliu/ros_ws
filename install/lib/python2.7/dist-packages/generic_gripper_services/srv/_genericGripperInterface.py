...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B2d.pack(_x.cmd_code, _x.test_upper_val, _x.test_lower_val))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cmd_code, _x.test_upper_val, _x.test_lower_val,) = _struct_B2d.unpack(str[start:end])
      return self
