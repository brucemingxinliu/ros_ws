...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2iBi.pack(_x.object_ID, _x.gripper_ID, _x.query_code, _x.grasp_option))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.object_ID, _x.gripper_ID, _x.query_code, _x.grasp_option,) = _struct_2iBi.unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_B.pack(self.valid_reply))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.valid_reply,) = _struct_B.unpack(str[start:end])
