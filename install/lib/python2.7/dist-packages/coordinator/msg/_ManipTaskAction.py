...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7di3I.pack(_x.action_goal.goal.gripper_goal_frame.pose.position.x, _x.action_goal.goal.gripper_goal_frame.pose.position.y, _x.action_goal.goal.gripper_goal_frame.pose.position.z, _x.action_goal.goal.gripper_goal_frame.pose.orientation.x, _x.action_goal.goal.gripper_goal_frame.pose.orientation.y, _x.action_goal.goal.gripper_goal_frame.pose.orientation.z, _x.action_goal.goal.gripper_goal_frame.pose.orientation.w, _x.action_goal.goal.perception_source, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.dropoff_frame.pose.position.x, _x.action_goal.goal.dropoff_frame.pose.position.y, _x.action_goal.goal.dropoff_frame.pose.position.z, _x.action_goal.goal.dropoff_frame.pose.orientation.x, _x.action_goal.goal.dropoff_frame.pose.orientation.y, _x.action_goal.goal.dropoff_frame.pose.orientation.z, _x.action_goal.goal.dropoff_frame.pose.orientation.w, _x.action_goal.goal.gripper_goal_frame.header.seq, _x.action_goal.goal.gripper_goal_frame.header.stamp.secs, _x.action_goal.goal.gripper_goal_frame.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
