...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7di.pack(_x.goal.gripper_goal_frame.pose.position.x, _x.goal.gripper_goal_frame.pose.position.y, _x.goal.gripper_goal_frame.pose.position.z, _x.goal.gripper_goal_frame.pose.orientation.x, _x.goal.gripper_goal_frame.pose.orientation.y, _x.goal.gripper_goal_frame.pose.orientation.z, _x.goal.gripper_goal_frame.pose.orientation.w, _x.goal.perception_source))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.dropoff_frame.pose.position.x, _x.goal.dropoff_frame.pose.position.y, _x.goal.dropoff_frame.pose.position.z, _x.goal.dropoff_frame.pose.orientation.x, _x.goal.dropoff_frame.pose.orientation.y, _x.goal.dropoff_frame.pose.orientation.z, _x.goal.dropoff_frame.pose.orientation.w, _x.goal.gripper_goal_frame.header.seq, _x.goal.gripper_goal_frame.header.stamp.secs, _x.goal.gripper_goal_frame.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
