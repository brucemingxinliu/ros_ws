...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_code, _x.object_id, _x.desired_frame.header.seq, _x.desired_frame.header.stamp.secs, _x.desired_frame.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_code, _x.object_id, _x.desired_frame.header.seq, _x.desired_frame.header.stamp.secs, _x.desired_frame.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
