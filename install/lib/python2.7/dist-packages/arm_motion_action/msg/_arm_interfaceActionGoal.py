...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_idi.pack(_x.goal.nsteps, _x.goal.arrival_time, _x.goal.nseg))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.nsteps, _x.goal.arrival_time, _x.goal.nseg,) = _struct_idi.unpack(str[start:end])
      return self
