...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.result.current_pose_gripper.header.seq, _x.result.current_pose_gripper.header.stamp.secs, _x.result.current_pose_gripper.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.current_pose_gripper.header.seq, _x.result.current_pose_gripper.header.stamp.secs, _x.result.current_pose_gripper.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.result.current_pose_gripper.pose.position.x, _x.result.current_pose_gripper.pose.position.y, _x.result.current_pose_gripper.pose.position.z, _x.result.current_pose_gripper.pose.orientation.x, _x.result.current_pose_gripper.pose.orientation.y, _x.result.current_pose_gripper.pose.orientation.z, _x.result.current_pose_gripper.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
