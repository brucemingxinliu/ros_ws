...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.current_pose_gripper.header.seq, _x.current_pose_gripper.header.stamp.secs, _x.current_pose_gripper.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.current_pose_gripper.pose.position.x, _x.current_pose_gripper.pose.position.y, _x.current_pose_gripper.pose.position.z, _x.current_pose_gripper.pose.orientation.x, _x.current_pose_gripper.pose.orientation.y, _x.current_pose_gripper.pose.orientation.z, _x.current_pose_gripper.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.current_pose_gripper.header.seq, _x.current_pose_gripper.header.stamp.secs, _x.current_pose_gripper.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.current_pose_gripper.pose.position.x, _x.current_pose_gripper.pose.position.y, _x.current_pose_gripper.pose.position.z, _x.current_pose_gripper.pose.orientation.x, _x.current_pose_gripper.pose.orientation.y, _x.current_pose_gripper.pose.orientation.z, _x.current_pose_gripper.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      return self
