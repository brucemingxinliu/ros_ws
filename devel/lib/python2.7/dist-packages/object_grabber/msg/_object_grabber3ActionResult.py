...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_id.pack(_x.result.return_code, _x.result.computed_move_time))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.return_code, _x.result.computed_move_time,) = _struct_id.unpack(str[start:end])
      return self
