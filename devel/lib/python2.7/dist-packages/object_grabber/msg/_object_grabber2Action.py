...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i3I.pack(_x.action_goal.goal.action_code, _x.action_goal.goal.object_id, _x.action_goal.goal.desired_frame.header.seq, _x.action_goal.goal.desired_frame.header.stamp.secs, _x.action_goal.goal.desired_frame.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_goal.goal.desired_frame.pose.position.x, _x.action_goal.goal.desired_frame.pose.position.y, _x.action_goal.goal.desired_frame.pose.position.z, _x.action_goal.goal.desired_frame.pose.orientation.x, _x.action_goal.goal.desired_frame.pose.orientation.y, _x.action_goal.goal.desired_frame.pose.orientation.z, _x.action_goal.goal.desired_frame.pose.orientation.w, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.return_code, _x.action_result.result.des_flange_pose_stamped_wrt_torso.header.seq, _x.action_result.result.des_flange_pose_stamped_wrt_torso.header.stamp.secs, _x.action_result.result.des_flange_pose_stamped_wrt_torso.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.position.x, _x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.position.y, _x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.position.z, _x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.orientation.x, _x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.orientation.y, _x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.orientation.z, _x.action_result.result.des_flange_pose_stamped_wrt_torso.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.action_code, _x.action_goal.goal.object_id, _x.action_goal.goal.desired_frame.header.seq, _x.action_goal.goal.desired_frame.header.stamp.secs, _x.action_goal.goal.desired_frame.header.stamp.nsecs,) = _struct_2i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.return_code, _x.action_result.result.des_flange_pose_stamped_wrt_torso.header.seq, _x.action_result.result.des_flange_pose_stamped_wrt_torso.header.stamp.secs, _x.action_result.result.des_flange_pose_stamped_wrt_torso.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
