...
struct arm_interfaceGoal_
{
  ...
  _nseg_type nseg;
    ...
    enum { ARM_TEST_MODE = 0u };
     ...
     enum { GET_Q_DATA = 7u };
     enum { PLAN_JSPACE_TRAJ_CURRENT_TO_WAITING_POSE = 20u };
     enum { PLAN_JSPACE_TRAJ_CURRENT_TO_QGOAL = 21u };
     enum { PLAN_JSPACE_TRAJ_CURRENT_TO_CART_TOOL_POSE = 22u };
     enum { PLAN_CARTESIAN_TRAJ_CURRENT_TO_DES_TOOL_POSE = 23u };
     enum { PLAN_CARTESIAN_TRAJ_QSTART_TO_DES_TOOL_POSE = 24u };
     enum { PLAN_CARTESIAN_TRAJ_QPREV_TO_DES_TOOL_POSE = 25u };
     enum { CLEAR_MULTI_TRAJ_PLAN = 26u };
     enum { APPEND_MULTI_TRAJ_CART_SEGMENT = 27u };
     enum { APPEND_MULTI_TRAJ_JSPACE_SEGMENT = 28u };
     enum { REFINE_PLANNED_TRAJECTORY = 41u };
     enum { EXECUTE_PLANNED_TRAJ = 100u };
     enum { EXECUTE_TRAJ_NSEG = 101u };
